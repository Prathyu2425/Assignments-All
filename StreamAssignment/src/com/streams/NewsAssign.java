...
public class NewsAssign {
    ...
    public static void main(String args[])
    {
        ...
        News news1 = new News(1, "prathyu", "usha", "comment");
        News news2 =new News(2, "prathyu1", "usha1", "budget");
        News news3 = new News(1, "prathyu2", "usha2", "comment");
        News news4 = new News(3, "prathyu3", "usha", "budget");
        News news5 = new News(1, "prathyu4", "usha2", "comment");
        News news6 = new News(3, "prathyu5", "usha", "budget");
        News news7 = new News(1, "prathyu6", "usha6" ,"comment");
